...
(cl:defmethod cl:initialize-instance :after ((m <IntList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_planning-msg:<IntList> is deprecated: use path_planning-msg:IntList instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <IntList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_planning-msg:data-val is deprecated.  Use path_planning-msg:data instead.")
  (data m))
